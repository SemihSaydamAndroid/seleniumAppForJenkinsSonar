...
//                             sh 'mvn sonar:sonar -Dsonar.sources=src -Dsonar.test.inclusions=src/test/java -Dsonar.qualitygate.wait=true'
                            sh 'mvn sonar:sonar -Dsonar.language=gherkin -Dsonar.tests=src/test -Dsonar.inclusions=src/test/java/resources/parallel/*.feature -Dsonar.qualitygate.wait=true'
//                     def sonarCommand = """
//                         mvn sonar:sonar \
